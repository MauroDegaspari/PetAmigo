...
@Entity
@Table(name ="funcionarios", schema ="dbapa")
public class AcessoFuncionarioModel {
    ...
    @Column(name = "data_nascim_func", nullable = false)
    private LocalDate dataNascimento;

    @Column(name = "sexo_func", nullable = false, length = 1)
    private String sexo;
    ...
    @Column(name = "sn_ativo_func", nullable = false, length = 1)
    ...
    @Column(name = "exame_admissional", length = 1)
    private String exameAdmissional;

    @Column(name = "comprovante_endereco", length = 1)
    private String comprovanteEndereco;

    @Column(name = "foto_func", length = 1)
    private String fotoFunc;

    @Column(name = "dependentes", length = 1)
	...
	public Long getCdFunc() {
		return cdFunc;
	}

	public void setCdFunc(Long cdFunc) {
		this.cdFunc = cdFunc;
	}
	...
	public String getFotoFunc() {
		return fotoFunc;
	}

	public void setFotoFunc(String fotoFunc) {
